...
struct qt_meta_stringdata_CLASSFriendInfoWidgetENDCLASS_t {};
static constexpr auto qt_meta_stringdata_CLASSFriendInfoWidgetENDCLASS = QtMocHelpers::stringData(
    "FriendInfoWidget",
    "enterWidget",
    "",
    "leaveWidget"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSFriendInfoWidgetENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSFriendInfoWidgetENDCLASS_t qt_meta_stringdata_CLASSFriendInfoWidgetENDCLASS = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_CLASSFriendInfoWidgetENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject FriendInfoWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSFriendInfoWidgetENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSFriendInfoWidgetENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSFriendInfoWidgetENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *FriendInfoWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSFriendInfoWidgetENDCLASS.stringdata0))
