...
public:
    ...
    void setupUi(QWidget *Logging)
    {
        ...
        stackedWidget->setGeometry(QRect(0, 0, 581, 431));
        ...
        pushBtn_close->setGeometry(QRect(510, 0, 34, 40));
...
"}"));
        ...
        pushBtn_hide->setGeometry(QRect(460, 0, 34, 40));
...
"}"));
        ...
        label_6->setGeometry(QRect(0, 9, 41, 41));
